...
public class SolicitacaoTeste {
    public static void main (String[] args) throws NomeInvalidoException, ValorValidoException, AnoInvalidoException, TensaoInvalidaException {
        ...
        try{
            Solicitacao s1 = new Solicitacao(new Requisitante("Elberth Moraes", 2,"Público", 1313423),p1,"C");
        ...
        try{
            Solicitacao s2 = new Solicitacao(new Requisitante("", 2,"Privado", 1313423),p1,"C");
        ...
        try{
            Solicitacao s3 = new Solicitacao(new Requisitante("João Pedro", 9,"Privado", 1313423),p1,"C");
            System.out.println(s3.imprimirSolicitacao());
        }  catch (TipoInsumoException | TipoAquisicaoException | SolicitacaoSemProdutoException | SolicitacaoSemRequisitanteException | ValorValidoException | NomeInvalidoException e) {
            System.out.println(e.getMessage());
        }
        try{
            Solicitacao s4 = new Solicitacao(new Requisitante("João Pedro", 2,"Privado", 1313423),p2,"Z");
            System.out.println(s4.imprimirSolicitacao());
        }  catch (TipoInsumoException | TipoAquisicaoException | SolicitacaoSemProdutoException | SolicitacaoSemRequisitanteException | ValorValidoException | NomeInvalidoException e) {
            System.out.println(e.getMessage());
        }
        try{
            Solicitacao s4 = new Solicitacao(new Requisitante("João Pedro", 4,"Privado", 1313423),p4,"A");
            System.out.println(s4.imprimirSolicitacao());
        }  catch (TipoInsumoException | TipoAquisicaoException | SolicitacaoSemProdutoException | SolicitacaoSemRequisitanteException | ValorValidoException | NomeInvalidoException e) {
            System.out.println(e.getMessage());
        }
