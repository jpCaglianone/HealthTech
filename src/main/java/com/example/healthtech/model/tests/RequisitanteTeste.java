...
public class RequisitanteTeste {
    public static void main(String[] args){
        ...
        try {
            Requisitante r1 = new Requisitante("João Pedro", 1,"Público", 99999999999999l);
        ...
        try {
            Requisitante r2 = new Requisitante("", 1,"Privado", 99999999999999l);
        ...
        try {
            Requisitante r2 = new Requisitante("João Pedro", 6,"", 99999999999999l);
            System.out.println(r2.toString());
        } catch (ValorValidoException | TipoInsumoException | NomeInvalidoException e) {
            System.out.println(e.getMessage());
        }
